<div class="bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 transition-colors" x-data="{ showPedomanModal: false, showGalleryModal: false, activeActivity: null, activePhotoIdx: 0 }">
    ...
    <section class="max-w-5xl mx-auto px-4 sm:px-6 py-20">
        <div class="p-6 sm:p-12 bg-gradient-to-br from-emerald-800 via-emerald-900 to-emerald-950 rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden space-y-6">
            ...
            <div class="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6">
                ...
                {{-- Kanan: Tombol Aksi --}}
                <div class="flex flex-wrap items-center justify-center sm:justify-end gap-2.5 flex-shrink-0">
                    @if(!empty($data['pedoman_file_url']))
                        {{-- Tombol Buka di Tab Baru (Khusus HP & Viewer Langsung Nativ) --}}
                        <a href="{{ route('pedoman.stream') }}" target="_blank" rel="noopener noreferrer"
                           class="inline-flex items-center justify-center gap-2 px-5 py-3.5 bg-emerald-500 hover:bg-emerald-600 text-white rounded-2xl text-xs font-black transition-all shadow-lg shadow-emerald-500/20 whitespace-nowrap hover:scale-105">
            ...
            @if(empty($data['pedoman_file_url']))
                <div class="relative z-10 mt-4 pt-4 border-t border-white/10 text-center">
