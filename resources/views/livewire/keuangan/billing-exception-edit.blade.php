        ...
        <div class="lg:col-span-8 bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800 p-6 sm:p-8 rounded-3xl shadow-sm space-y-6">
            ...
            <div class="space-y-4 border-t border-slate-100 dark:border-slate-800/80 pt-5">
                ...
                <div>
                    ...
                    <input type="text" wire:model.live.debounce.300ms="excNotes" placeholder="Contoh: Diskon Kakak-Adik, Beasiswa Abdi Dalem..." class="w-full bg-slate-50 dark:bg-slate-950 border @error('excNotes') border-rose-500 ring-1 ring-rose-500 @else border-slate-200/60 dark:border-slate-800 @enderror text-slate-800 dark:text-slate-200 rounded-xl px-4 py-2.5 text-xs focus:ring-blue-500 font-bold">
