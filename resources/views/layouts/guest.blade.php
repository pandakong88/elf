        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            <a href="/" class="flex items-center gap-3 group">
                ...
                <div class="flex flex-col">
                    <span class="font-extrabold text-base sm:text-lg tracking-tight text-slate-950 dark:text-white uppercase leading-tight font-serif-display">Al-Fithroh</span>
    ...
    <footer class="bg-slate-900 dark:bg-slate-950 border-t border-slate-800 py-16 transition-colors">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-2">
                        ...
                        @endif
                        <div>
                            <span class="font-extrabold text-sm tracking-tight text-white uppercase block">Al-Fithroh</span>
                            <span class="text-[10px] text-slate-500">Jejeran Bantul, DIY</span>
                        </div>
                    </div>
                    <p class="text-xs text-slate-400 leading-relaxed">
                        Pondok Pesantren Al-Fithroh membimbing santri dengan tradisi keilmuan Ahlussunnah wal Jama'ah sejak tahun 1970.
                    </p>
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start gap-2 text-xs text-slate-400">
                            ...
                            Jejeran, Wonokromo, Pleret, Bantul, DIY
                        </li>
                        <li class="flex items-start gap-2 text-xs">
                            ...
                            <span class="text-green-400">Putra: 0812-3456-789 / 0812-9876-543</span>
                        </li>
                        <li class="flex items-start gap-2 text-xs">
                            ...
                            <span class="text-rose-400">Putri: 0811-1222-333</span>
                        </li>
                        <li class="flex items-start gap-2 text-xs text-slate-400">
            ...
            <div class="border-t border-slate-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                <p class="text-xs text-slate-500">&copy; {{ date('Y') }} Pondok Pesantren Al-Fithroh. Hak Cipta Dilindungi.</p>
